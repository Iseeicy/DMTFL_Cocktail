...
if not sys.version_info[:2] == (3, 6):
    import mock
    import bandcampdl.requests_patch

from bandcampdl.__init__ import __version__

from bandcampdl.clean_print import print_clean
    ...
    def download_album(self, album: dict) -> bool:
        ...
        for track_index, track in enumerate(album['tracks']):
            ...
            while True:
                try:
                    if not sys.version_info[:2] == (3, 6):
                        with mock.patch('http.client.parse_headers', bandcampdl.requests_patch.parse_headers):
